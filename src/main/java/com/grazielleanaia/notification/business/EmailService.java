package com.grazielleanaia.notification.business;


import com.grazielleanaia.notification.business.dto.TarefasDTO;
import com.grazielleanaia.notification.infrastructure.exception.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        ...
        try{
            ...
            mimeMessageHelper.setSubject("Notification of tasks.");
